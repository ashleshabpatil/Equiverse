...
//     const users = [
//       { email: "user1@example.com", username: "UserOne", password: password1 },
//       { email: "user2@example.com", username: "UserTwo", password: password2 },
//     ];
...
app.get("/addUsers", async (req, res) => {
  try {
    const existingUser = await User.findOne({ email: "user1@example.com" });
    if (existingUser) {
      return res.send("Users already exist. Skipping insertion.");
    }
